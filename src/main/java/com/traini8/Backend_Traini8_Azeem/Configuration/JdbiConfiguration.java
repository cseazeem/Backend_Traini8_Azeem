package com.traini8.Backend_Traini8_Azeem.Configuration;
...
//        log.info("[I31] Installing rowMappers... ({} found)", rowMappers.size());
    ...
    @Bean
    public TrainingCenterDAO trainingCenterDAO(Jdbi jdbi) {
        return jdbi.onDemand(TrainingCenterDAO.class);
    }
}
